...
Latest phone delivery, 2026-09-12: Hermes Personal 2.17.0 / 21662 is installed and launched. It adds PDF/audio/video output handoff and thousands separators in usage displays, including all preceding milestones and the D15 context reopen fix. The release passed 1,139 tests with four opt-in skips; the six usage-panel checks passed after the formatting polish, and analysis is clean. The signed APK passed package/certificate checks. Phone verification covers installed identity and process metadata; live feature QA remains. Selected-host updates are included; a remote TUI restart contract, Firebase setup and remaining selected feature portions stay tracked in the delivery sequence.
