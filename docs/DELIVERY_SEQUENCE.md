...
| D23 | In progress | Scoped subagent roster, live details and supported Steer/Interrupt controls | Installed backend contract inspected | Active-only roster and transient tails; no persisted child history in this contract |
| D24-D30 | Planned | Not started | None | Check relevant deployed contracts at slice start |
