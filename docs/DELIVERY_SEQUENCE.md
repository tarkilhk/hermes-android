...
| D17 | Partial | Authenticated image/text and formatted Markdown/source previews, hosted web pages, binary save/share, external media handoff, in-app audio/video and PDF pages with zoom; see [opening files](OPENING_OUTPUT_FILES.md) and [PDF reading](PDF_READING.md) | 2.22.0: 1,166 full-suite passes/four skips before helper consolidation; 19 focused checks afterward; analyzer clean; signed Personal 21712 installed and launched | Downloaded interactive HTML remains; live PDF/browser/media QA pending |
