...
| D17 | Partial | Authenticated image/text preview, binary save/share, external PDF/audio/video handoff and in-app PDF pages with zoom; see [opening files](OPENING_OUTPUT_FILES.md) and [PDF reading](PDF_READING.md) | 2.20.0: 1,155 tests passed, four opt-in skips; analyzer clean; signed Personal 21692 installed and launched | Formatted Markdown file previews, interactive HTML and integrated audio/video remain; live PDF/viewer QA pending |
