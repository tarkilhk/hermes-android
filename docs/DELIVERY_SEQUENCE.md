...
| D12 | Mermaid previews implemented; live QA pending | Wide tables, selectable streamed/nested fenced code and copy/wrap controls; on-demand Mermaid preview with zoom and source access. See [diagram notes](DIAGRAM_PREVIEWS.md) | 2.19.0: 1,147 tests passed, four opt-in skips; analyzer clean; signed Personal 21682 installed and launched | Other diagram formats retain source fallback; live device preview/zoom QA remains |
| D13 | Partial | Tap-to-preview zoomable web images and hosted web page browser previews with external fallback; see [preview notes](MARKDOWN_AND_WEB_PREVIEWS.md) | 2.21.0: 1,161 tests passed, four opt-in skips; analyzer clean; signed Personal 21702 installed and launched | Integrated audio/video remains; live browser QA pending |
...
| D17 | Partial | Authenticated image/text and formatted Markdown/source previews, hosted web pages, binary save/share, external media handoff and in-app PDF pages with zoom; see [preview notes](MARKDOWN_AND_WEB_PREVIEWS.md) and [PDF reading](PDF_READING.md) | 2.21.0: 1,161 tests passed, four opt-in skips; analyzer clean; signed Personal 21702 installed and launched | Downloaded interactive HTML and integrated audio/video remain; live PDF/browser/viewer QA pending |
