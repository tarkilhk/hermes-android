...
| D28 | Diagnostics and session usage implemented; advanced access remains | Manual dashboard/provider checks, Manage connections repair route and server-recorded profile usage | 2.13.0: 1,103 tests passed, four opt-in skips; clean analyzer | Advanced proxy headers and live QA remain; no local usage ledger |
