...
3. D19 / C07: implemented and verified in 2.25.1; phone installation deferred. Explicitly opening
...
| D11 side/background task recovery | Implement the server task listing/resume contract and recover its cards. Transient live cards do not establish recovery. |
